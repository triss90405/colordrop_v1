...
<head>
  ...
  <link rel="apple-touch-icon" sizes="180x180" href="/assets/img/admin/apple-touch-icon.png">
  ...
  <link rel="mask-icon" href="/assets/img/admin/safari-pinned-tab.svg" color="#5bbad5">
